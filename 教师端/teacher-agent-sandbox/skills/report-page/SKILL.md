...
13. Hand-author `index.html` from the page plan. The first line must be `<!-- Generated by 教育智能体教师端 -->`. Use document components such as `doc-block`, `doc-callout`, `doc-metrics`, `doc-chart`, `doc-table`, `doc-diagram`, `doc-note`, and `doc-sources`. Keep prose, tables, sources, Mermaid source, and chart JSON directly readable in the HTML.
...
In the final response, include the page `index.html` path.
...
- Confirm `index.html` starts with `<!-- Generated by 教育智能体教师端 -->` on line 1.
- Confirm the final response includes the page `index.html` path.
